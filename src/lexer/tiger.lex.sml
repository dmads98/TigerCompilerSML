        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction45(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ46(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction45(strm, yyNO_MATCH)
                  else yyQ84(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ42(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
              else yyAction45(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction37(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction37(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction38(strm, yyNO_MATCH)
                      else yyQ42(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction38(strm, yyNO_MATCH)
                  else yyQ42(strm', yyMATCH(strm, yyAction38, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"/"
                  ...
                  then if inp = #")"
                      ...
                      then if inp = #"&"
                          ...
                          else yyQ10(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                    else if inp = #","
                      then yyQ14(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                    else if inp < #","
                      then if inp = #"*"
                          then yyQ12(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                          else yyQ13(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                    else if inp = #"-"
                      then yyQ15(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                      else yyQ16(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp = #">"
                  then yyQ23(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp < #">"
                  then if inp = #";"
                      then yyQ20(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                    else if inp < #";"
                      then if inp = #":"
                          then yyQ19(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                          else yyQ18(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                    else if inp = #"<"
                      then yyQ21(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                      else yyQ22(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp = #"["
                  then yyQ25(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp < #"["
                  then if inp <= #"@"
                      then yyQ7(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                      else yyQ24(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                else if inp = #"\\"
                  then yyQ24(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
                  else yyQ26(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
            else if inp = #"n"
...
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction3(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ5(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
