...
\\011\000\213\000\013\000\213\000\015\000\033\000\016\000\032\000\
\\017\000\031\000\018\000\030\000\026\000\213\000\027\000\213\000\
...
\\168\000\000\000\
\\169\000\000\000\
\\170\000\010\000\021\000\014\000\020\000\028\000\019\000\000\000\
...
\\186\000\000\000\
\\187\000\000\000\
\\188\000\045\000\041\000\000\000\
\\189\000\043\000\043\000\000\000\
\\190\000\000\000\
\\191\000\000\000\
\\192\000\000\000\
\\193\000\015\000\033\000\016\000\032\000\017\000\031\000\018\000\030\000\
\\019\000\029\000\020\000\028\000\021\000\027\000\022\000\026\000\
\\023\000\025\000\024\000\024\000\026\000\023\000\027\000\022\000\000\000\
...
\\204\000\000\000\
\\205\000\000\000\
\\206\000\005\000\147\000\000\000\
\\207\000\000\000\
\\208\000\017\000\031\000\018\000\030\000\000\000\
\\209\000\017\000\031\000\018\000\030\000\000\000\
\\210\000\000\000\
\\211\000\000\000\
\\212\000\000\000\
\\219\000\015\000\033\000\016\000\032\000\017\000\031\000\018\000\030\000\
\\019\000\029\000\020\000\028\000\021\000\027\000\022\000\026\000\
...
\\077\000\055\000\076\000\082\000\
\\054\000\011\000\010\000\010\000\
\\010\000\007\000\070\000\116\000\
\\067\000\010\000\012\000\010\000\
...
\\069\000\037\000\115\000\114\000\
...
\\073\000\010\000\039\000\061\000\
\\046\000\038\000\035\000\065\000\
\\063\000\068\000\033\000\056\000\
\\085\000\018\000\010\000\019\000\
\\021\000\042\000\080\000\079\000\
\\032\000\060\000\010\000\052\000\
\\064\000\010\000\084\000\010\000\
\\102\000\053\000\022\000\104\000\
\\099\000\050\000\036\000\028\000\
\\029\000\010\000\010\000\075\000\
\\058\000\010\000\066\000\057\000\
\\023\000\040\000\105\000\010\000\
\\030\000\010\000\024\000\025\000\
\\044\000\078\000\016\000\062\000\
\\103\000\106\000\098\000\010\000\
\\026\000\097\000\047\000\107\000\
\\010\000\059\000\096\000\048\000\
...
exp_seq1, _, _)) :: _ :: ( _, ( MlyValue.ntVOID exp1, expleft, _)) :: 
...
|  ( 28, ( ( _, ( MlyValue.ntVOID structBuilder1, structBuilder1left, 
...
|  ( 30, ( ( _, ( _, _, END1right)) :: _ :: ( _, ( MlyValue.ntVOID 
...
|  ( 32, ( ( _, ( MlyValue.ntVOID dec1, dec1left, dec1right)) :: 
rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val  (
dec as dec1) = dec1 ()
 in ([dec])
end; ()))
...
|  ( 33, ( ( _, ( MlyValue.ntVOID dec1, _, dec1right)) :: ( _, ( 
...
|  ( 34, ( ( _, ( MlyValue.ntVOID typelist1, typelist1left, 
...
|  ( 35, ( ( _, ( MlyValue.ntVOID funclist1, funclist1left, 
...
|  ( 36, ( ( _, ( MlyValue.ntVOID vardec1, vardec1left, vardec1right))
 :: rest671)) => let val  result = MlyValue.ntVOID (fn _ => ( let val 
...
|  ( 37, ( ( _, ( MlyValue.ntVOID funcdec1, funcdec1left, 
...
|  ( 38, ( ( _, ( MlyValue.ntVOID funcdec1, _, funcdec1right)) :: ( _,
...
|  ( 42, ( ( _, ( MlyValue.ntVOID exp1, _, exp1right)) :: _ :: _ :: _
...
|  ( 45, ( ( _, ( MlyValue.ntVOID typedec1, typedec1left, 
...
|  ( 46, ( ( _, ( MlyValue.ntVOID typedec1, _, typedec1right)) :: ( _,
...
|  ( 50, ( ( _, ( _, _, RBRACE1right)) :: ( _, ( _, LBRACE1left, _))
 :: rest671)) => let val  result = MlyValue.ntVOID (fn _ => (
A.RecordTy([])))
...
|  ( 53, ( ( _, ( MlyValue.ntVOID type_fields1, _, type_fields1right))
...
|  ( 58, ( ( _, ( MlyValue.ntVOID exp1, expleft, exp1right)) :: ( _, (
...
|  ( 67, ( ( _, ( MlyValue.INT INT1, INT1left, INT1right)) :: rest671)
