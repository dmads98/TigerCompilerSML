...
fun yyAction16 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos (" illegal format sequence character"); continue()))
fun yyAction17 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("illegal escape string character"); continue()))
...
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos (" illegal string character"); continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction63(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ63(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction26(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction26(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ105(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ38 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction49(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ112(strm', yyMATCH(strm, yyAction49, yyNO_MATCH))
       ...
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"2"
              ...
              then if inp = #" "
                  then yyQ9(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp < #" "
                  then if inp = #"\v"
                  ...
                  then if inp = #"!"
                      then yyAction17(strm, yyNO_MATCH)
                      else yyQ10(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
                else if inp <= #"/"
                  then yyAction17(strm, yyNO_MATCH)
...
in
  (case (!(yyss))
   of STR => yyQ0(!(yystrm), yyNO_MATCH)
    ...
    | FORMATSEQ => yyQ3(!(yystrm), yyNO_MATCH)
  (* end case *))
end
            end
	  in 
